...
type InferSchemaType<T, K extends keyof T> = T[K] extends z.ZodNumber ? number : T[K] extends z.ZodString ? string : T[K] extends z.ZodBoolean ? boolean : T[K] extends z.ZodEnum<infer U> ? U[number] : T[K] extends z.ZodDate ? Date : T[K] extends z.ZodOptional<z.ZodNumber> ? number | undefined : T[K] extends z.ZodOptional<z.ZodString> ? string | undefined : T[K] extends z.ZodOptional<z.ZodBoolean> ? boolean | undefined : T[K] extends z.ZodOptional<z.ZodEnum<infer U>> ? U[number] | undefined : T[K] extends z.ZodOptional<z.ZodDate> ? Date | undefined : T[K] extends z.ZodArray<infer U> ? InferSchemaType<{
    ...
    [key: string]: InferSchemaType<U, keyof U>;
} | undefined : T[K] extends z.ZodUnion<infer U> ? U[number] : T[K] extends z.ZodOptional<z.ZodUnion<infer U>> ? U[number] | undefined : T[K] extends z.ZodPromise<infer U> ? InferSchemaType<U, keyof U> : T[K] extends z.ZodOptional<z.ZodPromise<infer U>> ? InferSchemaType<U, keyof U> | undefined : T[K] extends z.ZodLazy<infer U> ? InferSchemaType<U, keyof U> : T[K] extends z.ZodOptional<z.ZodLazy<infer U>> ? InferSchemaType<U, keyof U> | undefined : T[K] extends z.ZodDefault<z.ZodString> ? string : T[K] extends z.ZodDefault<z.ZodNumber> ? number : T[K] extends z.ZodDefault<z.ZodBoolean> ? boolean : T[K] extends z.ZodDefault<z.ZodEnum<infer U>> ? U[number] : any;
