...
var EnvironmentManager = class {
  ...
  createEnvSchema(cb) {
    ...
    this.rootPath = this.schema.envFilePath || import_path.default.resolve(__dirname);
  ...
  collectEnvs() {
    ...
    if (typeof envFileHierarchy === "string") {
      ...
      if (!import_fs.default.existsSync(envPath) && !this.schema.throwErrorOnValidationFail) {
